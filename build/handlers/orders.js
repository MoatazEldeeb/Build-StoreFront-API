...
var CurrentOrderByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.getCurrentOrderByUser(parseInt(req.params.userId))];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var createOrderProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderProduct, addedProduct, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderProduct = {
...
var orderRoutes = function (app) {
    app.get('/orders/users/:userId', verifyToken_1.default, CurrentOrderByUser);
    app.get("/orders", index);
    app.post("/orders/products", verifyToken_1.default, createOrderProduct);
};
