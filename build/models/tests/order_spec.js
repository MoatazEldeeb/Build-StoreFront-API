...
describe("Order Model", function () {
    ...
    it("should have a Get current order by user id method", function () {
    ...
    it("CREATE method should add an order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), user_id = _a.user_id, completed = _a.completed;
                    expect({ user_id: user_id, completed: completed }).toEqual({
                        user_id: "3",
                        completed: true,
                    });
                    return [2 /*return*/];
    ...
    it("INDEX method should return a list of all orders", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = (_b.sent())[0], user_id = _a.user_id, completed = _a.completed;
                    expect({ user_id: user_id, completed: completed }).toEqual({
                        user_id: 3,
                        completed: true,
                    });
