...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, pepperedPassword, salt, hashPassword, result, User, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        conn = _a.sent();
                        pepperedPassword = "".concat(u.password_digest).concat(pepper);
                        return [4 /*yield*/, bcrypt_1.default.genSalt(parseInt(saltRounds))];
                    case 2:
                        salt = _a.sent();
                        hashPassword = bcrypt_1.default.hashSync(pepperedPassword, salt);
                        return [4 /*yield*/, conn.query(sql, [u.name, hashPassword])];
                    case 3:
                        result = _a.sent();
                        User = result.rows[0];
                        conn.release();
                    ...
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("Could not add new User ".concat(u.name, ". Error: ").concat(err_3));
